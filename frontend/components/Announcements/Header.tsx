...
const Header: React.FC = () => {
    ...
    return (
        <div className=' w-[95%]  [@media(min-width:900px)]:w-[85vw] mx-auto  pt-5  [@media(min-width:900px)]:pt-10 flex items-center  justify-between '>
            <div onClick={() => router.push("/")} className="relative   h-[52px] w-[168px] lg:h-[70px] lg:w-[230px] xl:h-[82px] xl:w-[265px]">
                <Image
                    alt="logo"
                    src="/Logo.png"
                    fill
            ...
            <div className="flex  flex-col  [@media(min-width:900px)]:flex-row gap-4 pt-5 [@media(min-width:900px)]:pt-0 ">
                <DateRangePicker
