...
export default function ShareSection({ Announcement, setisShareOPen }: Props) {
    ...
    const bg = isDark ? "#1a1212" : "#ffffff"
    const surface = isDark ? "#251919" : "#fafafa"
    const text = isDark ? "#f5eeee" : "#321F1F"
    const border = isDark ? "rgba(245,238,238,0.1)" : "rgba(50,31,31,0.1)"
    const borderHover = isDark ? "rgba(245,238,238,0.28)" : "rgba(50,31,31,0.25)"
    const divider = isDark ? "rgba(245,238,238,0.08)" : "rgba(50,31,31,0.08)"
    const accent = "#c51057"
    ...
    return (
        <div
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#050505]/40 backdrop-blur-sm"
            style={{ fontFamily: "var(--font-satoshi)" }}
        >
            <div
                ref={modalRef}
                className="relative w-full max-w-md mx-4 overflow-hidden rounded-2xl shadow-2xl animate-in slide-in-from-bottom-4 duration-300"
                ...
                <div className="p-8 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <h3
                            ...
                            style={{ color: accent, fontFamily: "var(--font-literata)" }}
                        >
                            {TranslateText[language].SHARE_ANNOUNCEMENT}
                        </h3>
                        <p
