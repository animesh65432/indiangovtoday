...
const Announcement: React.FC<Props> = ({ Announcement }) => {
    ...
    return (
        <div className='p-2 flex items-center rounded-md justify-between w-[97%] bg-[#FFFFFF] pb-3'>
            ...
            <Button className='bg-[#FFFFFF] border border-[#E0614B] text-[#E0614B] rounded-xl'>See Details</Button>
        </div>
    )
}
